...
## Propiedad de esta release

En esta release **tú eres el dueño del estado publicado**: nadie más va a
verificarlo detrás de ti. Si informas de que `0.4.0` está publicada, el equipo lo
tratará como cierto y repinará sus consumidores sobre ello.
